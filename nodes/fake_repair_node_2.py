...
if __name__ == '__main__':
  ...
  feasibility_check = rospy.ServiceProxy('feasibility_check', PrimitiveFeasibilityCheck)
  Skills = SkillPrimitiveArray()
  skill1 = SkillPrimitive()
  skill1.name = "skill_test"
  skill1.dir = [-1,0]
  skill1.current_terrain_type = 5
  skill1.next_terrain_type = 5
